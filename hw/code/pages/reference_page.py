...
class RefPage(WebPage):
    ...
    input_search = WebElement(xpath='//div[@class="Search_fullscreen__hU6UF"]//label[@class="vkuiSearch__control"]//input')
    ...
    selector_sections = ManyWebElements(xpath='//span[@class="NavigationItem_content__dsNgk" and @title="Инструменты рекламы"]')
    section_utm_marks = ManyWebElements(xpath='//span[@class="NavigationItem_content__dsNgk NavigationItem_contentNotActive__JI134" and @title="UTM-метки"]')
